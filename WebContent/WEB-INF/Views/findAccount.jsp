...
<title>BEH Bank: Search Account Holder</title>
</head>
<body>
	<div class="container">
	<%@ include file="header.jsp" %>
		...
		<div class="row" id="divResults">
			<div class="col-8">
				<div class="card-header bg-success test-white">
	...
	<script>
		...
		function searchViaAjax(){
			...
			$.ajax({
				...
				url : "http://localhost:8080/BEHBankApp/account",
		...
		function display(data){
			...
			$('#accountNumber').html("Account Balance:"+ data["accountBalance"]);
			$('#divErrors').hide();
			$('#divResults').show();
		}
	</script>
